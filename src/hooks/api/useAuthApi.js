...
export default () => {
  const selector = useCallback(state => ({
    ...
    get2faKeyIsFetching: querySelectors.isPending(
      state.get('queries'),
      { queryKey: endpoints.get2faKeyUrl() },
    ) || false,
    get2faKeyIsFinish: querySelectors.isFinished(
      state.get('queries'),
      { queryKey: endpoints.get2faKeyUrl() },
    ) || false,
    ...
    get2faCodesIsFinish: querySelectors.isFinished(
      state.get('queries'),
      { queryKey: endpoints.get2faCodesUrl() },
    ) || false,
    get2faCodeIsFetching: querySelectors.isPending(
      state.get('queries'),
