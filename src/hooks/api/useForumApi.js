...
import {
  ...
  putTopic,
  putVote,
} from '@cashelec/shared/api/forum';
  ...
  const selector = useCallback(
    (state) => ({
      ...
      getSearchIsFetching:
        ...
        false,
      getStatisticIsFetching:
        querySelectors.isPending(state.get('queries'), {
          queryKey: endpoints.getStatisticUrl(),
        }) || false,
      getStatisticUserIsFetching:
        querySelectors.isPending(state.get('queries'), {
