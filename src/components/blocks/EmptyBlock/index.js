    ...
    case 'completedDeals': {
      return (
        <StyledColumn>
          ...
          <AlignCenterText>
            Количество завершенных сделок влияет на вашу репутацию на сервисе и
            повышает отклики на ваши объявления
          </AlignCenterText>
          <BasicButton
            onClick={onClick}
            title="Найти предложения"
    ...
    case 'subscriptions': {
      return (
        <StyledColumn>
          ...
          <SecondaryBoldText paddingBottom={15}>Нет подписок</SecondaryBoldText>
          <AlignCenterText>
      ...
      return (
        <StyledColumn>
          ...
          <AlignCenterText paddingBottom={15}>
            Если вы не нашли соответствующего предложения в маркете, сформируйте
            его сами! Добавьте свое первое объявление о покупке или продаже
            криптовалюты.
          </AlignCenterText>
          <BasicButton
            onClick={onClick}
